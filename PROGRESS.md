...
4. **P4:** IN PROGRESS — plan: `.hermes/plans/p4-daily-loop-plan-2026-08-13.md` (4 slices: qty_kg honesty → Reconcile screen → week-lock + mo_changes export → loop framing/weekly roll)
   ...
   - **Slice 4 ✅ DONE:** nav restructured to walk the daily loop (Home · 1 Connect · 2 Reconcile · 3 Plan · 4 Lock & Export · 5 Track · Setup) per user request "UI should follow our process"; weekly roll advances the lock with the anchor (one action). Deeper page decluttering proposed to user.
